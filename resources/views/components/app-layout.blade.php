...
<head>
    ...
    <title>{{ $title ?? config('app.name', 'SISTEM KURSUS') }}</title>
...
<body class="bal-kit">
    <div class="min-vh-100 d-flex flex-column">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary">
            <div class="container">
                <a class="navbar-brand fw-semibold" href="{{ url('/') }}">
                    {{ config('app.name', 'SISTEM KURSUS') }} {{-- Ubah ini --}}
                </a>
        ...
        <main class="flex-grow-1">
            {{ $slot ?? ($content ?? '') }} {{-- INI PENTING: Konten dari komponen/halaman akan masuk di sini --}}
        </main>
